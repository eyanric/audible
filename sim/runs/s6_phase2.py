...
CANDIDATES: tuple[tuple[str, str | None, dict, str], ...] = (
    ...
    ("age", None, {}, "FFA vintage age"),
    ("uncertainty", None, {}, "FFA sd_pts relative to points"),
    ("ffa_ceiling", None, {}, "FFA ceiling as a multiple of the projection"),
    ("ffa_floor", None, {}, "FFA floor as a multiple of the projection"),
    ("ffa_spread", None, {}, "FFA (ceiling - floor) / points"),
    ("ffa_tier", None, {}, "FFA tier, negated"),
    ("ffa_dropoff", None, {}, "FFA points to the next player at the position"),
    ("ffa_aav", None, {}, "FFA auction value: the market's own price"),
    ("ffa_experience", None, {}, "FFA years of experience"),
    ("ffa_uncertainty", None, {}, "FFA published uncertainty, negated"),
    ("depth_slot", None, {}, "prior-season mean depth-chart slot, negated"),
    ("ff_opp_exp", None, {}, "prior-season expected fantasy points per game"),
    ("ff_opp_diff", None, {}, "prior-season points over expected per game"),
